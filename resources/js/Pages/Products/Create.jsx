...
export default function Create({ auth, vendor, vendors = [] }) {
    ...
    const canSelectVendor = auth.user.user_type === 'EVENT_ADMIN' || auth.user.user_type === 'SUPER_ADMIN';
                        ...
                        <div className="p-6">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    {canSelectVendor && vendors.length > 0 && (
                        ...
                        <div className="mt-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div className="p-6">
                                ...
                                <div className="max-w-md">
                                    ...
                                    />
                                    <div className="hidden text-center p-4 border border-gray-200 rounded-md">
